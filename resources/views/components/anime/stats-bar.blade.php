...
<div class="flex items-center justify-center gap-4 text-sm mx-auto">
    <!-- Members -->
    <div class="flex items-center gap-1.5" title="Members tracking this anime">
    ...
    <!-- Favorites -->
    <div class="flex items-center gap-1.5" title="Users who favorited this anime">
    ...
    <!-- Rank -->
    @if ($rank)
        <div class="flex items-center gap-1.5" title="MAL Ranking">
